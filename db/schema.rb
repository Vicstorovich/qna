...
ActiveRecord::Schema.define(version: 20_190_826_141_435) do
  ...
  create_table 'course_users', force: :cascade do |t|
    ...
    t.index %w[user_id course_id], name: 'index_course_users_on_user_id_and_course_id', unique: true
  end
  ...
  create_table 'courses', force: :cascade do |t|
    ...
    t.string 'image'
    t.integer 'user_id'
    t.string 'type', default: 'Course', null: false
    t.integer 'number_hours_video'
    t.integer 'number_hours_practice'
